...
const InfirmierRouter = require('./routes/profiles/infirmierRouter')
const PharmacianRouter = require('./routes/profiles/pharmacianRouter')
...
router.use('/infirmier' , InfirmierRouter)
router.use('/pharmacian' , PharmacianRouter)
